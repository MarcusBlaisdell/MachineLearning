...
-----------------------
There are total three Python files including 'main.py', 'solution.py' and 'helper.py'. In all assignments, you only need to add your solution in 'solution.py' file following the given instruction. 
